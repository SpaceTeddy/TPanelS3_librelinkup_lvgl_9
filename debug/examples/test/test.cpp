 ...
 * @LastEditTime: 2025-08-22 14:42:45
 * @License: GPL 3.0
 */
...
void CAN_Drive_Initialization()
{
    ...
    // Configuration
    uint32_t alerts_to_enable = TWAI_ALERT_TX_IDLE | TWAI_ALERT_TX_SUCCESS | TWAI_ALERT_TX_FAILED | TWAI_ALERT_ERR_PASS | TWAI_ALERT_BUS_ERROR | TWAI_ALERT_RX_DATA | TWAI_ALERT_RX_QUEUE_FULL;
...
void setup()
{
    ...
    digitalWrite(ESP32H2_BOOT, HIGH);
...
void loop()
{
    if (digitalRead(0) == LOW)
    {
        ...
        gfx->draw16bitRGBBitmap(0, 0, (uint16_t *)gImage_1, 480, 480);
...
//             gfx->XL_digitalWrite(XL95X5_RS485_CON, HIGH);
//             SerialPort2.printf("RS485 port 2: %d", Uart_Count);
...
//     }
    ...
    if (Touch_Flag == 1)
    {
        ...
        Touch_Flag = 0;
        TP_Point t = touch.getPoint(0); //  gets coordinates of the touch screen
