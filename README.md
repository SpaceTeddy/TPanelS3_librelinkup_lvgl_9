 ...
 * @LastEditTime: 2024-11-21 14:46:56
 * @License: GPL 3.0
-->
...
| [openHASP](https://github.com/HASwitchPlate/openHASP) | `[Platformio IDE][espressif32-v6.5.0]`<br />`[openHASP][0.7.0]` | Detailed development process introduction can be found at [openHASP Development Documentation](https://openhasp.haswitchplate.com/0.7.0/) | <p align="center" width="10%"> <img src="image/1.png" alt="example" width="80%"> </p> |
